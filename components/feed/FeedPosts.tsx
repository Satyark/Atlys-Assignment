    ...
    <div className='justify-center items-center'>
     {(postData?.length ? [...postData].reverse() : []).map((post, i) => (
      // <FeedCard name={post.author} img={post.profile} time={post.time} content={post.content} comments={post.comments}/>
        <div className='sm:w-[700px] w-[350px] p-1 border-[2px] border-[#35373B] bg-[#27292D] rounded-[8px] mt-2 ml-3' key={i}>
        ...
        <div className='flex items-center sm:w-[660px] w-[310px] h-[107px] bg-[#191920] mx-3 rounded-[8px]'>
