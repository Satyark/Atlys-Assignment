        ...
        <div className="bg-[#27292D] p-5 rounded-lg shadow-lg w-[463px] max-w-sm">
          <div className="flex justify-center items-center mb-6 mt-4">
            <div className="text-center font-semibold">
              <h3 className="text-[#6B6C70] text-[12px]">WELCOME BACK</h3>
          ...
          <div className="my-2">
            <div className="flex justify-between items-center rounded-[4px]">
              ...
              <a
                href="#"
                className="text-sm text-gray-400 text-[10px] hover:underline"
              >
                Forgot password?
              </a>
            </div>
            <div className="flex items-center justify-between w-full p-2 mt-[1.5px] text-[#7F8084] text-[14px] bg-transparent border border-[#35373B] rounded-md">
              <input
                type={passwordType}
          ...
          <button
            type="submit"
            className="mt-1 w-full bg-[#4A96FF] hover:opacity-80 transition duration-300 text-white text-[14px] p-2 rounded-[4px]"
            onClick={handleLogin}
          >
            Login now
          </button>
